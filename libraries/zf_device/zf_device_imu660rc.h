...
#define IMU660RC_INT2_PIN               ( ERU_CH3_REQ3_P10_3 )                                 // 中断信号引脚，在读取四元数时需要使用
...
#define IMU660RC_EMB_FUNC_EN_B      ( 0x05 )
#define IMU660RC_EMB_FUNC_EXEC_STAT ( 0x07 )
#define IMU660RC_EMB_FUNC_CFG       ( 0x63 )
#define IMU660RC_EMB_FUNC_INIT_A    ( 0x66 )
#define IMU660RC_PAGE_ADDRESS       ( 0x08 )
#define IMU660RC_PAGE_VALUE         ( 0x09 )
#define IMU660RC_SFLP_GBIASX_L     ( 0x6E )
#define IMU660RC_SENSOR_HUB_1      ( 0x02 )
...
uint8   imu660rc_bias_calibrate     (uint32 duration_ms);  // 静止采样校准零偏并注入SFLP
